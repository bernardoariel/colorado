...
class ModeloVentas{
	...
	static public function mdlMostrarVentasFcUltima($tabla, $item, $valor){
		...
		$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla where tipo like 'FC' and id >".$valor);
	...
	$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE id_cliente = :id and adeuda > 0 order by fecha asc limit 1");
	...
	static public function mdlRangoFechasVentas2($tabla, $fechaInicial, $fechaFinal){
		...
		if($fechaInicial == null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE codigo<> '1' ORDER BY codigo desc limit 150");
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE fecha like '%$fechaFinal%' and codigo<> '1' ORDER BY codigo DESC ");
...
/*=============================================
	...
	static public function mdlHomologacionVenta($tabla,$datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET  fecha = :fecha,codigo = :codigo,cae =:cae,fecha_cae=:fecha_cae WHERE id =:id");
